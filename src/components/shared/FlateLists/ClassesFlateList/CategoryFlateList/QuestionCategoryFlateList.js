...
function QuestionCategoryDataFlateList({ item, themecolor, boxSize }) {
...
export function QuestionCategoryFlateList(props) {
  ...
  return (
    <FlatList
      data={props.data}
      renderItem={({ item }) => (
        <QuestionCategoryDataFlateList item={item} themecolor={themecolor} boxSize={props.boxSize} />
      )}
      // numColumns={2}
      // horizontal={false}
