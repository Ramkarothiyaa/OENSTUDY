...
import { ResultFlateList } from '../../components/shared/FlateLists/ResultFlateList/ResultFlateList';
import { getResults } from '../../repository/ResultRepository/ResultRepo';
...
export default function Result(props) {
    ...
    return (
        <View style={{ ...styles.bg, backgroundColor: themecolor.THEMECOLOR }}>
            ...
            <Header title="Results" backIcon={true}
